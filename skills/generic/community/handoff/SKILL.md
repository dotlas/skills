...
continue the work. Save to the temporary directory of the user’s OS - not the current
workspace.

Include a “suggested skills” section in the document, which suggests skills that the
agent should invoke.
