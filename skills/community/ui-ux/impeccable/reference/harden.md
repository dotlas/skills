...
Harden the interface against the inputs, errors, languages, and network conditions that
...
**IMPORTANT**: Hardening is about expecting the unexpected.
Real users will do things you never imagined.
